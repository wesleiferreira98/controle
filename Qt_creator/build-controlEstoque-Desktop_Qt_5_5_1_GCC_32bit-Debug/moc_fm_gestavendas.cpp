...
#include "../../../../../../Qt_creator/Documentos/Qt_Creator/controlEstoque/fm_gestavendas.h"
...
void fm_gestaVendas::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        fm_gestaVendas *_t = static_cast<fm_gestaVendas *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject fm_gestaVendas::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_fm_gestaVendas.data,
      qt_meta_data_fm_gestaVendas,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *fm_gestaVendas::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_fm_gestaVendas.stringdata0))
        return static_cast<void*>(const_cast< fm_gestaVendas*>(this));
