...
#include "../agenda_cfb_v1-0/janelalogin.h"
...
const QMetaObject JanelaLogin::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_JanelaLogin.data,
      qt_meta_data_JanelaLogin,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *JanelaLogin::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_JanelaLogin.stringdata0))
        return static_cast<void*>(const_cast< JanelaLogin*>(this));
